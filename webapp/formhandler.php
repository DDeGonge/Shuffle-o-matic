...
{
    fwrite($fp, "HOLD," . $_POST['nplayers'] . "," . $_POST['flop_card0'] . "," . $_POST['flop_suit0'] . "," . $_POST['flop_card1']
    . "," . $_POST['flop_suit1'] . "," . $_POST['flop_card2'] . "," . $_POST['flop_suit2'] . "," . $_POST['turn_card0']
    . "," . $_POST['turn_suit0'] . "," . $_POST['river_card0'] . "," . $_POST['river_suit0']
